...
// Include both Gmail and Google Sheets scopes
const SCOPES = [
...
console.log("3. Enable Gmail API and Google Sheets API");
console.log("4. Replace CLIENT_ID and CLIENT_SECRET above");
console.log("");
...
rl.question("Enter the authorization code here: ", async (code) => {
  try {
    ...
    console.log("");
    console.log("🎉 You can now use Gmail API and Google Sheets API!");
  } catch (error) {
