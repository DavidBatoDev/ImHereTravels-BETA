...
async function testSimpleRecompute() {
  try {
    ...
    console.log(
      `📝 Current content preview: ${(data.content || "").substring(0, 100)}...`
    );
    ...
    console.log(
      "🚀 Triggering onTypeScriptFunctionUpdatedSimple by updating document..."
    );
    ...
    console.log(
      "📊 Check the Firebase Console logs to see the function execution:"
    );
    console.log(
      "   https://console.firebase.google.com/project/imheretravels-a3f81/functions/logs"
    );
