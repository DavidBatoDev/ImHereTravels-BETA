...
export default function Receipt({
  ...
  return (
    <div className="receipt-container">
      ...
      <div className="receipt-header bg-gradient-to-r from-crimson-red to-red-600 text-white p-6 rounded-lg mb-4 print:rounded-none print:border-t-2 print:border-gray-300 print:mt-6 print:pt-6 flex items-start justify-between print:print-color-adjust-exact">
        <div>
      ...
      <div className="bg-muted/30 rounded-lg p-6 print:bg-gray-50 print:rounded-none">
        {/* Amount Paid Section */}
