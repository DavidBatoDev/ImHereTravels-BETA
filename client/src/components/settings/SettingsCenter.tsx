...
export default function SettingsCenter() {
  ...
  const canManageEmails = userProfile?.permissions?.canManageEmails;
  const canManageFunctions = userProfile?.permissions?.canManageFunctions;
  const canManageStorage = userProfile?.permissions?.canManageStorage;
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <TabsContent value="system" className="space-y-6">
          <TabPermissionGuard permission="canManageStorage" tabName="System">
            <Card className="border border-royal-purple/20 dark:border-border shadow hover:shadow-md transition-all duration-200">
              <CardHeader className="bg-muted/50 border-b border-royal-purple/20 dark:border-border">
                <CardTitle className="text-foreground">
