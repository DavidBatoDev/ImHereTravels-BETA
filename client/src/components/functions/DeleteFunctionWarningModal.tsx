...
interface DeleteFunctionWarningModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  functionName: string;
...
export function DeleteFunctionWarningModal({
  isOpen,
  onClose,
  onConfirm,
  functionName,
  affectedColumns,
  affectedFunctions,
}: DeleteFunctionWarningModalProps) {
  return (
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle className="text-lg font-semibold">
              Delete Function Warning
            </DialogTitle>
          </div>
          <DialogDescription className="text-sm text-muted-foreground">
            Deleting the function{" "}
            <span className="font-medium">"{functionName}"</span> will also
            delete all columns and functions that depend on this function (both
            directly and indirectly). This action cannot be undone.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                <p className="font-medium text-amber-800">
                  ...
                  {affectedColumns.length !== 1 ? "s" : ""} and{" "}
                  {affectedFunctions.length} function
                  {affectedFunctions.length !== 1 ? "s" : ""} will be deleted:
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                ...
                <ul className="mt-1 list-disc list-inside text-red-700 space-y-1">
                  ...
                  <li>All function files will be permanently deleted</li>
                  <li>
                    Any other columns or functions that reference these items
        ...
        <DialogFooter className="gap-2">
          ...
          <Button variant="destructive" onClick={onConfirm} className="gap-2">
            ...
            Delete {affectedFunctions.length + 1} Function
