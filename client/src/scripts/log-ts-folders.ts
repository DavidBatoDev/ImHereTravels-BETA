...
/**
 * Script to export all documents from the ts_folders collection as JSON
 * Returns all fields from each document using spread operator
 *
 * Usage:
 *   npm run log-ts-folders
 *   or
...
console.log("🚀 Starting ts_folders collection export...");

// Fetch all documents from Firebase collection
async function fetchTSFolders(): Promise<any[]> {
  try {
