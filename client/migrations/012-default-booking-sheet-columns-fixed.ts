...
// Define SheetColumn type locally to avoid import issues
...
const MIGRATION_ID = "012-default-booking-sheet-columns-fixed";
...
export default {
  id: MIGRATION_ID,
  name: "Default Booking Sheet Columns (Fixed)",
  description:
    "Populate bookingSheetColumns collection with all 60 default columns for the hybrid booking system (Fixed version)",
  run: runMigration,
